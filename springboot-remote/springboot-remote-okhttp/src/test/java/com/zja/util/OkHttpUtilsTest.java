...
//        String url = "http://localhost:19000/get/param/v1";
        ...
        String response = OkHttpUtils.doGet(url, params);
...
//        String url = "http://localhost:19000/post";
        ...
        String response = OkHttpUtils.doPost(url, params);
...
//        String url = "http://localhost:19000/post/object/v1";
        ...
        String response = OkHttpUtils.doPost(url, JSON.toJSONString(params));
...
//        String url = "http://localhost:19000/put";
        ...
        String response = OkHttpUtils.doPut(url, params);
...
//        String url = "http://localhost:19000/delete";
        ...
        String response = OkHttpUtils.doDelete(url, params);
    ...
    public void testdoPostUploadFile() throws IOException {
        ...
        String response = OkHttpUtils.doPostUploadFile(url, file);
    ...
    public void testdoPostUploadFileWithParams() throws IOException {
        ...
        String response = OkHttpUtils.doPostUploadFile(url, file, params);
    ...
    public void testdoPostUploadFileList() throws IOException {
        ...
        String response = OkHttpUtils.doPostUploadFiles(url, files);
    ...
    public void testdoPostUploadFileListWithParams() throws IOException {
        ...
        String response = OkHttpUtils.doPostUploadFiles(url, files, params);
...
//        String url = "http://localhost:19000/get/download/v2";
        ...
        // Act
        InputStream stream = OkHttpUtils.doGetDownloadFile(url, params);
...
//        String url = "http://localhost:19000/file/jpg.jpg";
        ...
        params.put("filename", "jpg.jpg");
        // Act
        InputStream stream = OkHttpUtils.doPostDownloadFile(url, params);
