...
/**
 * Aho Corasick自动机，应用于分词可以取得1400万字每秒，约合27MB/s的分词速度。
 * <p>
 * 参考：http://www.hankcs.com/program/algorithm/aho-corasick-double-array-trie.html
 * 参考：https://github.com/hankcs/AhoCorasickDoubleArrayTrie/tree/master
 *
 * @Author: zhengja
...
public class AhoCorasickDoubleArrayTrieTest {
    ...
    public void testBuildVeryLongWord() throws Exception {
        ...
        List<AhoCorasickDoubleArrayTrie.Hit<String>> result = acdat.parseText(word);
...
//        Map<String, String> map = new LinkedHashMap<String, String>();
    ...
    public void testBuildEmptyTrie() {
        ...
        List<AhoCorasickDoubleArrayTrie.Hit<String>> hits = acdat.parseText("uhers");
