...
import com.dist.dto.FTPDirDTO;
import com.dist.dto.FtpCfgDTO;
...
public class FtpUtil {
    ...
    public static void main(String[] args) {
        String hostName = "192.168.2.124";
        String userName = "distftp";
	 ...
	 * @throws IOException
	 */
	public static List<FTPDirDTO> getSubDirectory(
											FTPClient ftp,
											String relativeDir,
										   int level) throws IOException {
		logger.info("relativeDir>>>>>>>>>>>>>>>>> {}",relativeDir);
		ftp.enterLocalPassiveMode();
		List<FTPDirDTO> filePathList = new ArrayList<>();
