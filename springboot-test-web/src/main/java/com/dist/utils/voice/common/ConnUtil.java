package com.dist.utils.voice.common;
...
public class ConnUtil {
     ...
     */
    public static String getResponseString(HttpURLConnection conn) throws Exception, DemoException {
     ...
     * @param conn
     * @return
     * @throws Exception   http请求错误
     * @throws DemoException http 的状态码不是 200
     */
    public static byte[] getResponseBytes(HttpURLConnection conn) throws Exception, DemoException {
     ...
     * @param is
     * @return
     * @throws Exception @see InputStream.read()
     */
