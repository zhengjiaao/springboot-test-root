...
public class SpeechRecognitionTest {
    ...
    private final String APP_KEY = "SDI4E7QfxrYmQpvYFTmC4eun";

    // 填写网页上申请的APP SECRET 如 $SECRET_KEY="94dc99566550d87f8fa8ece112xxxxx"
    private final String SECRET_KEY = "552Mb6qjhefzWfCASGhyMmvpNhYAWesD";

    // 需要识别的文件，推荐使用 .pcm  仅支持语音文件在60s以内
    //private final String FILENAME = "16k_test.pcm";
    private final String FILENAME = "需要点勇气.pcm";
    ...
    */
    ...
    private String runRawPostMethod(String token) throws Exception{
