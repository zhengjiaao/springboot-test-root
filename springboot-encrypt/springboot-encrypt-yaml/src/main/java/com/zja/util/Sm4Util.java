...
//        String text = "这是一段明文语句.";
        ...
        String encrypt = Sm4Util.encrypt(text);
        System.out.println("加密后：" + encrypt);

        String decrypt = Sm4Util.decrypt(encrypt);
        ...
        String encrypt2 = Sm4Util.encrypt(text, key);
        System.out.println("加密后：" + encrypt2);

        String decrypt2 = Sm4Util.decrypt(encrypt2, key);
