 ...
 */
@SpringBootTest
public class MapReduceWordCountDriverTest {
    ...
    public void test_local() throws Exception {
        ...
        job.setJarByClass(MapReduceWordCountDriverTest.class); // 设置作业的主类
        ...
        // 配置输入和输出路径
        FileInputFormat.addInputPath(job, new Path("input_word_count.txt")); // 读取的是项目根路径下的文件
        FileOutputFormat.setOutputPath(job, new Path("output_word_count")); // 输出的是项目根路径下目录
    ...
    public void test_yarn() throws Exception {
        ...
        // 配置输入和输出路径
        FileInputFormat.addInputPath(job, new Path("input.txt")); // 读取的是项目根路径下的文件
        FileOutputFormat.setOutputPath(job, new Path("output")); // 输出的是项目根路径下目录
