...
public class LocalDateTimeUtilTest {
    ...
    private final long sampleTimestamp = LocalDateTimeUtil.toTimestamp(sampleDateTime); // 获取对应时间戳


    @Test
    void testParseDefault() {
        String input = "2025-05-28 14:30:00";
        LocalDateTime result = LocalDateTimeUtil.parseDefault(input);
        assertEquals(sample, result);
    }

    @Test
    void testFormatDefault() {
        String result = LocalDateTimeUtil.formatDefault(sample);
    ...
    void testParseISO() {
        ...
        LocalDateTime result = LocalDateTimeUtil.parseISO(input);
        assertEquals(sample, result);
    }

    @Test
    void testFormatISO() {
        String result = LocalDateTimeUtil.formatISO(sample);
    ...
    void testParseChinese() {
        ...
        LocalDateTime result = LocalDateTimeUtil.parseChinese(input);
        assertEquals(sample, result);
    }

    @Test
    void testFormatChinese() {
        String result = LocalDateTimeUtil.formatChinese(sample);
    ...
    void testParseCompact() {
        ...
        LocalDateTime result = LocalDateTimeUtil.parseCompact(input);
        assertEquals(sample, result);
    }

    @Test
    void testFormatCompact() {
        String result = LocalDateTimeUtil.formatCompact(sample);
    ...
    void testParseWithInvalidFormatThrowsException() {
        assertThrows(DateTimeParseException.class, () -> {
            LocalDateTimeUtil.parseChinese("2025/05/28 14:30:00");
        });
    }

    @Test
    void testFormatTimeOnly() {
        assertEquals("14:30:00", LocalDateTimeUtil.formatTimeOnly(sample));
    }

    @Test
    void testFormatChineseTimeOnly() {
        assertEquals("14时30分00秒", LocalDateTimeUtil.formatChineseTimeOnly(sample));
    }

    @Test
    void testFormatChineseFull() {
        String result = LocalDateTimeUtil.formatChineseFull(sampleDateTime);
    ...
    void testFormatChineseSimple() {
        ...
        String result = LocalDateTimeUtil.formatChineseSimple(dateTime);
        assertEquals("2025年6月15日 14时3分5秒", result);
    }

    @Test
    void testFormatAmerican() {
        String result = LocalDateTimeUtil.formatAmerican(sampleDateTime);
    ...
    void testParseChineseFull() {
        ...
        assertNotNull(LocalDateTimeUtil.parseChineseFull(input));
    }

    @Test
    void testParseChineseSimple() {
        String input = "2025年6月5日 14时30分5秒";
        assertNotNull(LocalDateTimeUtil.parseChineseSimple(input));
    }

    @Test
    void testParseAmerican() {
        String input = "06/15/2025 14:30:00";
        assertNotNull(LocalDateTimeUtil.parseAmerican(input));
    }
    ...
    void testParseWithInvalidInputThrowsException() {
        assertThrows(DateTimeParseException.class, () -> {
            LocalDateTimeUtil.parseChineseFull("2025年06月15日");
        });
    }

    @Test
    void testParseDateOnly() {
        LocalDateTime result = LocalDateTimeUtil.parseDateOnly("2025-06-15");
    ...
    void testFormatDateOnly() {
        ...
        String result = LocalDateTimeUtil.formatDateOnly(now);
    ...
    void testParseChineseDateOnly() {
        LocalDateTime result = LocalDateTimeUtil.parseChineseDateOnly("2025年06月15日");
        assertEquals("2025-06-15T00:00", result.toString());
    }
    ...
    void testFormatChineseDateOnly() {
        ...
        String result = LocalDateTimeUtil.formatChineseDateOnly(now);
    ...
    void testToLocalDateTime_withValidDate() {
        ...
        LocalDateTime result = LocalDateTimeUtil.toLocalDateTime(date);
    ...
    void testToDate_withValidLocalDateTime() {
        Date result = LocalDateTimeUtil.toDate(sampleDateTime);
        assertNotNull(result);
        LocalDateTime back = LocalDateTimeUtil.toLocalDateTime(result);
    ...
    void testFromTimestamp() {
        LocalDateTime result = LocalDateTimeUtil.fromTimestamp(sampleTimestamp);
        assertNotNull(result);
        assertEquals(sampleDateTime, result);
    }
    ...
    void testToTimestamp() {
        long result = LocalDateTimeUtil.toTimestamp(sampleDateTime);
    ...
    void testRoundTrip_Date_LocalDateTime_Date() {
        ...
        LocalDateTime ldt = LocalDateTimeUtil.toLocalDateTime(original);
        Date roundTrip = LocalDateTimeUtil.toDate(ldt);
    ...
    void testRoundTrip_Timestamp_LocalDateTime_Timestamp() {
        LocalDateTime ldt = LocalDateTimeUtil.fromTimestamp(sampleTimestamp);
        long roundTrip = LocalDateTimeUtil.toTimestamp(ldt);
