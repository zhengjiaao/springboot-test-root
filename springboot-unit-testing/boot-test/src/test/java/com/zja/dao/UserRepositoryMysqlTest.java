...
/**
 * 加载【外部数据库】 Mysql、Pg、Oracle等
 * <p>
 * 使用 @DataJpaTest 和 @AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE) 注解来指定一个外部数据库
 * </p>
...
public class UserRepositoryMysqlTest {
    ...
    @Test
    // @Commit // todo 无效，事务显示回滚了，但是数据库中插入的数据依旧未删除。
    // @Rollback(value = true) // todo 无效，事务显示回滚了，但是数据库中插入的数据依旧未删除。
