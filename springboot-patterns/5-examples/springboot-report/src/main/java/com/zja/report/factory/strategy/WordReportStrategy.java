 ...
 *
 * @Author: zhengja
 * @Date: 2024-11-05 10:02
 */
@Slf4j
@Component
public class WordReportStrategy extends ReportGenerateHandler implements ReportStrategy {

    public static final ReportType REPORT_TYPE = ReportType.TEST_WORD_10001;
    ...
    private Map<String, Object> buildReportRequest(ReportRequest request) {
        Map templateData = ResourcesFileUtil.readJSONObjectFromFile("/template/XX报告模版-模拟数据.json", Map.class);
        return templateData;
    }
