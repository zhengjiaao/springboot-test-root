...
public class YamlAnalysisController {
    ...
    public Object getYml() throws Exception {
        ...
        System.out.println("Resource" + YamlAnalysisController.class.getResource("").getPath());
        // "/"  则表示从根目录../../target/classes/ 目录开始搜索
        System.out.println("Resource2" + YamlAnalysisController.class.getResource("/").getPath());
        // ""  则表示从根目录../../target/classes/ 目录开始搜索
        System.out.println("ClassLoader" + YamlAnalysisController.class.getClassLoader().getResource("").getPath());

        //Map<String, Object> map = YamlUtils.yamlHandler(new ClassPathResource("application.yml"));

        URL url = YamlAnalysisController.class.getClassLoader().getResource("application.yml");
