...
import com.zja.easyexcel.db.FileExcleDBApplication;
...
@SpringBootTest(classes = FileExcleDBApplication.class)
public class BaseTests {
     ...
     *     将任何对象转换为json字符串，并打印
     */
    protected static  <T> void printlnAnyObj(T obj) {
     ...
     *     将任何对象转换为json字符串，并打印
     */
    protected static  <T> void printlnAnyObj(String key, T obj) {
