...
import com.zja.easyexcel.model.read.*;
...
public class ReadTest {
     ...
     *
     * <p>
     * 1. 创建excel对应的实体对象 参照{@link DemoExceptionData}
     * <p>
    ...
    public void exceptionRead() {
        String fileName = TestFileUtil.getPath() + "demo" + File.separator + "demo.xlsx";
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet
        EasyExcel.read(fileName, DemoExceptionData.class, new DemoExceptionListener()).sheet().doRead();
    }
