...
import com.zja.easyexcel.model.fill.FillData;
import com.zja.easyexcel.model.read.DemoData;
import com.zja.easyexcel.util.TestFileUtil;
...
public class FillTest {
    ...
    public void testFill(){
        ...
        List<FillData> fillData = data();
        // EasyExcel.write(fileName, DemoData.class).inMemory(true).sheet("模板").doWrite(fillData());
        EasyExcel.write(templateFileName, DemoData.class).inMemory(true).sheet("模板").doWrite(fillData);
    }
