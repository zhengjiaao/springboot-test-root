...
- [springboot-patterns 重学Java设计模式](./springboot-patterns)
    - [1-creational-patterns 创建型模式](./springboot-patterns/1-creational-patterns)
    - [2-structural-patterns 结构型模式](./springboot-patterns/2-structural-patterns)
    - [3-behaviour-patterns  行为型模式](./springboot-patterns/3-behaviour-patterns)
...
- [springboot-ocr OCR识别提取](./springboot-ocr)
...
- [springboot-unit-testing 单元测试](./springboot-unit-testing)
    - [springboot-unittest-junit](springboot-unit-testing/boot-test)
...
| springboot-ocr      | 预研OCR相关技术(图文识别、音频识别、...)                   | 计划中     |
