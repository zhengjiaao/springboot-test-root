...
! function(t, e) {
	...
	var e = function(t) {
		...
		n = function(t, e) {
			if(!(t instanceof e)) throw new TypeError("Cannot call a class as a server")
		},
		r = function() {
			function t(t, e) {
...
// 图片地址在此处更换  可换成你的图片
var assets = [
	'https://files.cnblogs.com/files/cjsblog/reward-1.bmp',
	'https://files.cnblogs.com/files/cjsblog/reward-2.bmp',
	'https://files.cnblogs.com/files/cjsblog/reward-3.bmp',
	'https://files.cnblogs.com/files/cjsblog/reward-4.bmp',
	'https://files.cnblogs.com/files/cjsblog/reward-5.bmp',
];
...
Promise.all(assets).then(function(images) {
	...
	document.getElementsByClassName('journal-reward')[0].addEventListener('click', function() {
		...
		//	stage.bubble(image, 3000, server(lifespan) {
		//		if(lifespan >= 0) {
