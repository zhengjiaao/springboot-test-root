package com.dist.aop;

import com.dist.base.dto.PageDTO;
...
public class UserServiceAspect {
    ...
    @Pointcut("execution(public * com.dist.service.impl.AOPEncryptImpl.*(..)) && @annotation(com.dist.annotation.DREncrypt)" )
